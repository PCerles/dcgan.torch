...
opt = {
    ...
    name = 'images_normal/check100',  -- name of the file saved
    gpu = 2,               -- gpu mode. 0 = CPU, 1 = GPU
    display = 1,           -- Display image: 0 = false, 1 = true
    nz = 100,
    ncond = 300,              
    input_caption = 'two buses'
}
...
--image.save("gen_img/" .. opt.input_caption .. '.png', image.toDisplayTensor(images))
image.save(opt.name .. ".png",image.toDisplayTensor(images))
print('Saved image to: ', opt.name)
